            ...
            this.authService.currentUser.subscribe(
              currentUser => {
                this.userService.changePass(currentUser.id, user).subscribe(() => {
                  ...
                  this.toast.success({detail:"Thông báo", summary: "Thay đổi mật khẩu thành công!",duration: 3000,position:'br'})
                }, err => {
                  console.log(err)
                  this.toast.error({detail:"Thông báo", summary: "Mật khẩu này đã từng được sử dụng!",duration: 3000,position:'br'})
                });
              }
            )
          }
